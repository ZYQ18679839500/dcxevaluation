CREATE TABLE t_econo_benefit_1
(
    ...
    CONSTRAINT pk_t_econo_benefit_1_id PRIMARY KEY (id),
    CONSTRAINT fk_t_econo_benefit_1_project_id FOREIGN KEY (project_id) REFERENCES t_project(id),
    CONSTRAINT fk_t_econo_benefit_1_expert_id FOREIGN KEY (expert_id) REFERENCES t_expert(id),
    CONSTRAINT ck_t_econo_benefit_1_state CHECK (state IN(1,2))
);