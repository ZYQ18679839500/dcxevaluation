...
(
    ...
    F_Social FLOAT(5, 2) NOT NULL,
    S_Social_Develop FLOAT(5, 2) NOT NULL,
    S_Social_People FLOAT(5, 2) NOT NULL,
    S_Social_Green FLOAT(5, 2) NOT NULL,
    F_Work FLOAT(5, 2) NOT NULL,
    F_Work_Brand FLOAT(5, 2) NOT NULL,
    F_Work_Develop FLOAT(5, 2) NOT NULL,
