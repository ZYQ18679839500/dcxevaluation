...
public class Project {
    ...
    private Long additionNumber;
    private Long otherId;
    private float fGrade = -1.0f;
    private float lGrade = -1.0f;
    private float finalGrade = -1.0f;
    private int prizeType;//用于终评识别该项目参与评审的金奖类型
    private float impression = -1.0f;
    ...
    public Long getAdditionNumber() {
        return additionNumber;
    }

    public void setAdditionNumber(Long additionNumber) {
