...
public class ProjectServiceTest extends FcxevaluationApplicationTests {
    ...
    public void updateProject()
    {
        ...
        float grade=project.getFinalGrade();
    ...
    {
        List<Project> project = projectService.queryProjectsByStateAndPrizeType(3, 21);
        log.info("ProjectServiceTest.queryProjectById: " + project.size());
    }*/
